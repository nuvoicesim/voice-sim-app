...
import { createResponse, parseJsonBody, HTTP_STATUS, buildCorsHeaders, requireRuntimeTokenClaims, applyRuntimeClaimsToBody, RuntimeTokenError, resolveRuntimeConfig, } from "../shared";
import { validateTtsRequest } from "./validation";
import { applyVoicePolicy } from "./voicePolicy";
...
const TTS_VALIDATION_MODE = (process.env.TTS_VALIDATION_MODE ?? "lenient");
...
export const handler = async (event) => {
    ...
    const { effectiveProfile, adjustedFields } = applyVoicePolicy(requestedProfile, {
